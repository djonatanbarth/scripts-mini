...
//http://phim47.com/movie-list/phim-le/2
//http://phim47.com/the-loai-phim-hanh-dong/page/2
if (strpos($search,"movie-list") === false) {
if($page > 1) {
	$l=$search."/page/".$page;
} else {
    $page = 1;
...
foreach($videos as $video) {
   ...
   $t2=explode('"',$t1[1]);
   $title=$t2[0];
   //$link = $host."/scripts/filme/php/phim47_link.php?query=".$link;
    ...
    <script>
    showIdle();
    url2="http://127.0.0.1/cgi-bin/scripts/filme/php/phim47_link.php?file='.urlencode($link).'";
    url3=getURL(url2);
    url=url3;
    cancelIdle();
