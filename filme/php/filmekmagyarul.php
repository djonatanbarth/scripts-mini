...
$videos = explode('div class="hoverTop clearfix">', $html);
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[2]);
    $link = "http://www.filmekmagyarul.com".$t2[0];

    $t1 = explode('src="', $video);
    $t2 = explode('"', $t1[2]);
    $image = "http://www.filmekmagyarul.com".$t2[0];

    $t1 = explode('title="', $video);
    $t2 = explode('"', $t1[2]);
    $title = htmlspecialchars_decode($t2[0]);

    $link = $host.'/scripts/filme/php/filmekmagyarul_link.php?file='.$link;
