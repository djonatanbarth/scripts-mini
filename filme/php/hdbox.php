...
$link="http://hd-box.org/alle-filme.html";
$tit="hd-box.org - Alle Filme";
?>
<rss version="2.0">
<onEnter>
  startitem = "middle";
...
//$html = file_get_contents($link);
  ...
  curl_close($ch);
//echo $link;
$html = str_between($html,'<ul class="sub-items">','</ul');
...
foreach($videos as $video) {
    ...
    if ($link <> "") {
       $down = $tit." ".$title;
       $link = 'http://127.0.0.1/cgi-bin/scripts/filme/php/hdbox_link.php?file='.$link.','.urlencode($title);
