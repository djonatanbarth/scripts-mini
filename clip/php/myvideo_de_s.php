...
<?php
//http://www.myvideo.de/Videos_A-Z?lpage=2&searchWord=funny+clip&searchOrder=0
$search=str_replace(" ","+",$search);
$link="http://www.myvideo.de/Videos_A-Z?lpage=".$page."&searchWord=".$search."&searchOrder=0";
...
$videos = explode('vCont video_list', $html);
unset($videos[0]);
...
foreach($videos as $video) {
  ...
  $link=$link.".flv";
//http://is3.myvideo.de/de/movie22/18/thumbs/8206894_0.jpg
//http://is4.myvideo.de/de/movie22/18/8206894.flv

  $t1 = explode("title entry-title'>", $video);
  $t2 = explode('<', $t1[1]);
  $title = $t2[0];
  $title = trim($title);
