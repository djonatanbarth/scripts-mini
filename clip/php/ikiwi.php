...
<channel>
	<title>www.ikiwi.at</title>
	<menu>main menu</menu>


<?php
$page = $_GET["query"];
//http://www.ikiwi.at/videos/top_videos/page/1/
$page1=$page-1;
$link="http://www.ikiwi.at/videos/top_videos/page/".$page1."/";
...
foreach($videos as $video) {
  ...
  $t2=explode('"',$t1[1]);
  $link="http://www.ikiwi.at/".$t2[0];
  //http://www.ikiwi.at/uploads/videos/Contrasehen_loves_MySpace.flv
  //http://www.ikiwi.at/vd/v/Contrasehen_loves_MySpace/
  $t1 = explode('src="', $video);
  $t2 = explode('"', $t1[1]);
  $image = "http://www.ikiwi.at/".$t2[0];
  ...
  $link = 'http://127.0.0.1/cgi-bin/scripts/clip/php/ikiwi_link.php?file='.$link;
	echo'
	<item>
	<title>'.$title.'</title>
    <onClick>
