...
<?php
//http://vimeo.com/user4936621/videos/page:2/sort:newest
//http://vimeo.com/user4936621/videos/page:1/sort:newest
if($page) {
	$html = file_get_contents("http://vimeo.com/user".$search."/videos/page:".$page."/sort:newest");
} else {
  $page = 1;
  $html = file_get_contents("http://vimeo.com/user".$search."/videos/page:".$page."/sort:newest");
}
...
} elseif (strpos($html,'<div class="clip">') !== false) {
$videos = explode('<div class="clip">', $html);
unset($videos[0]);
$videos = array_values($videos);
