...
<?php
//http://vimeo.com/channels/idealist/page:1
if($page) {
	$html = file_get_contents("http://vimeo.com/channels/".$search."/page:".$page);
} else {
  $page = 1;
  $html = file_get_contents("http://vimeo.com/channels/".$search."/page:".$page);
}
...
<?php } ?>
<?php
if (strpos($html,'<li id="clip_') !== false) {
$videos = explode('<li id="clip_', $html);
unset($videos[0]);
