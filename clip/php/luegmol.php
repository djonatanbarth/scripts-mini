...
<channel>
	<title>www.luegmol.ch</title>
	<menu>main menu</menu>


<?php
$page = $_GET["query"];
//http://www.luegmol.ch/videos?ct=all&order=mr&page=1
$link="http://www.luegmol.ch/videos?ct=all&order=mr&page=".$page;
...
$videos = explode('<div id="UserThumb">', $html);
unset($videos[0]);
...
foreach($videos as $video) {
  ...
  $link = 'http://127.0.0.1/cgi-bin/scripts/clip/php/luegmol_link.php?file='.$link;
  $baseurl="http://127.0.0.1/cgi-bin/scripts/util/translate.cgi?stream,Rtmp-options:-W%20http://www.luegmol.ch/player/player.swf,";
	echo'
	<item>
	<title>'.$title.'</title>
    <onClick>
