...
$link="http://www.myvideo.de/Serien";
$html = file_get_contents($link);
if ($query==1) {
$t1=explode("Neue  Folgen",$html);
$t2=explode("Top 100 Serien",$t1[1]);
$html=$t2[0];
} elseif ($query==2) {
$t1=explode("Top 100 Serien &",$html);
$t2=explode("Beliebte Highlight Clips",$t1[1]);
$html=$t2[0];
//echo $html;
} else {
$html=str_between($html,"Beliebte Highlight Clips","<div class='body rightFW'>");
}
$videos = explode("<div class='pChHead'>", $html);
unset($videos[0]);
...
foreach($videos as $video) {
  ...
  $image = $t2[0];
    ...
    $t1=explode("/",$link);
    $link="http://".$t1[2]."/de/".$t1[4]."/".$t1[5]."/".$t1[6];
