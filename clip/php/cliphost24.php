...
<channel>
	<title>www.cliphost24.com</title>
	<menu>main menu</menu>


<?php
$page = $_GET["query"];
//http://www.cliphost24.com/archiv-2.html
$link="http://www.cliphost24.com/archiv-".$page.".html";
...
foreach($videos as $video) {
  ...
  $t2=explode('"',$t1[1]);
  $link="http://www.cliphost24.com".$t2[0];
  ...
  $t2 = explode('"', $t1[1]);
  $image = "http://www.cliphost24.com".$t2[0];
  ...
  $link = 'http://127.0.0.1/cgi-bin/scripts/clip/php/cliphost24_link.php?file='.$link;
