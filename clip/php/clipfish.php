...
$link="http://www.clipfish.de/videos/neu/".$page."/";
...
$videos = explode('id="cf-video-item', $html);
unset($videos[0]);
...
foreach($videos as $video) {
  ...
  $t2 = explode('"', $t1[1]);
  $image = $t2[0];
//http://bilder.clipfish.de/media/thumbs/62/738867712b3a15b43b2809b09bf7e89a62_th.jpg
//http://pg1.clipfish.de/media/44/
  if (strpos($image,"thumbs") !==false) {
  $id=explode("thumbs",$image);
  } else {
  $id=explode("images",$image);
  }
  $id=$id[1];
  $id=explode("_",$id);
  $id=$id[0];
  $link="http://pg1.clipfish.de/media".$id;
  $link = $host."/scripts/clip/php/clipfish_link.php?file=".$link;
