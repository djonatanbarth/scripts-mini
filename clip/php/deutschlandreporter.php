...
<?php
$link="http://www.deutschlandreporter.de/mediadetails.php";
...
foreach($videos as $video) {
  ...
  $id=$t3[2];
  $l=$t2[0];
  $link="http://media1.deutschlandreporter.de/videos/".$id.".flv";
  ///videos/3931/
  //http://media1.deutschlandreporter.de/videos/3925.flv
  ...
  if ((strpos($l,"videos") !== false) && ($title <> "")){
	echo'
	<item>
	<title>'.$title.'</title>
    <onClick>
