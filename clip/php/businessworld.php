...
<?php
$page = $_GET["query"];
//http://www.businessworld.de/index.cfm/:var:menue:H01M0:defaultselect:1:PageNum:1
$link="http://www.businessworld.de/index.cfm/:var:menue:H01M0:defaultselect:1:PageNum:".$page;
...
$videos = explode('div class="videoEintrag"', $html);
unset($videos[0]);
...
foreach($videos as $video) {
  ...
  $link = 'http://127.0.0.1/cgi-bin/scripts/clip/php/businessworld_link.php?file='.$link;
	echo'
	<item>
	<title>'.$title.'</title>
    <onClick>
