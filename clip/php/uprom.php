...
<channel>
	<title>www.uprom.tv</title>
	<menu>main menu</menu>


<?php

$link="http://www.uprom.tv/UPromTV/Home,\$Component.NavigationHead.videoListViewLink.sdirect";
//$link="http://www.uprom.tv/UPromTV/";
...
for ($i=1;$i<4;$i++) {
  ...
  $html = curl_exec($ch);
  curl_close($ch);
  if (strpos($html,'id="clip"') !==false) break;
  sleep(2);
  }
...
foreach($videos as $video) {
  ...
  $link = 'http://127.0.0.1/cgi-bin/scripts/clip/php/uprom_link.php?file='.$link;
