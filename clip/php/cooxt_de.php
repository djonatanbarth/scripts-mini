...
$link="http://www.cooxt.de/index.php?mode=videos&page=".$page."&order=newest";
...
$videos = explode('<div class="index_video">', $html);
unset($videos[0]);
$videos = array_values($videos);

foreach($videos as $video) {
  $id = str_between($video,"watch.php?v=",'"');

  $t1 = explode('src="', $video);
  $t2 = explode('"', $t1[1]);
  $image = "http://www.cooxt.de/".$t2[0];
  //http://www.cooxt.de/_video_server/_2_allowed/1200000011.flv
  $link="http://www.cooxt.de/_video_server/_2_allowed/".$id.".flv";

  $t1 = explode('title="', $video);
  $t2 = explode('"', $t1[1]);
  $title = $t2[0];
  $title=str_between($video,'video_titel_link">','<');
  $title = str_replace("&nbsp;","",$title);
  $title = trim($title);
  $annotation = str_between($video,'class="index_video_description">','</div>');
