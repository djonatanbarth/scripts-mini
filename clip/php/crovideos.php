...
<channel>
	<title>www.crovideos.com</title>
	<menu>main menu</menu>


<?php
$page = $_GET["query"];
//http://www.crovideos.com/videos/basic/mr/2
$link="http://www.crovideos.com/videos/basic/mr/".$page;
...
foreach($videos as $video) {
  ...
  $t2 = explode('"',$t1[1]);
  $link = $t2[0];
  //http://www.crovideos.com/video/2748/Villa-Vizula-in-Medulin-Istria
  $t1=explode("/",$link);
  $id=$t1[4];
  $link="http://www.crovideos.com/flvideo/".$id.".flv";
