...
<channel>
	<title>Radio - favorite list</title>
	<menu>main menu</menu>
<?php
...
echo '
<item>
<annotation>Save your favorite radio station in a playlist "radio.m3u" and place this file on Hard disk or USB device</annotation>
</item>
';
} else {
$m3uFile = file($f);
