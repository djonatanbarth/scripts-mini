...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/tv/php/justintv_add.php?mod=add," + getItemInfo(getFocusItemIndex(),"link1") + "," + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
{
 showIdle();
 url="http://127.0.0.1/cgi-bin/scripts/tv/php/justintv_add.php?mod=delete," + getItemInfo(getFocusItemIndex(),"link1") + "," + getItemInfo(getFocusItemIndex(),"title1");
 dummy=getUrl(url);
 cancelIdle();
 redrawDisplay();
 ret="true";
...
*/
    ...
    <script>
    showIdle();
    url="'.$host.'/scripts/tv/php/justintv_link.php?file='.$link.'";
    url1=getUrl(url);
